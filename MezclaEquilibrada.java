...
public class MezclaEquilibrada {
    ...
    public void mezclaCuenta(String archivo) throws IOException{
        boolean b;
    ...
    public void mezclaNombre(String archivo) throws IOException{
        boolean b;
         b = mezclaENombre(archivo);    
        do{
            mezclaDNombre(b);            
            b = mezclaENombre("f0.txt");
        } while(b==false);
    }
    
    public void mezclaApellido(String archivo) throws IOException{
        boolean b;
         b = mezclaEApellido(archivo);    
        do{
            mezclaDApellido(b);            
            b = mezclaEApellido("f0.txt");
        } while(b==false);
    }
    
    public boolean mezclaECuenta(String archivo) throws IOException{   
        boolean b = true;  
        String cadena;
    ...
    public void mezclaDCuenta(boolean b) throws FileNotFoundException, IOException{        
        if(b==true) return;
        String cadenaf1;
        String cadenaf2;
    ...
    public void mezclaDNombre(boolean b) throws FileNotFoundException, IOException{        
        if(b==true) return;
        String cadenaf1;
        String cadenaf2;
    ...
    public void mezclaDApellido(boolean b) throws FileNotFoundException, IOException{        
        if(b==true) return;
        String cadenaf1;
        String cadenaf2;
